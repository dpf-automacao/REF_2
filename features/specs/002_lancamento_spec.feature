...
Funcionalidade: Realizar Lancamento Periodico
...
Cenario: Inserir Lancamento Periodico com sucesso
    ...
    E Informo Periodo "01/11/2019" a "05/11/2019" e Seleciono o 
    E Tipo de Ocorrencia "Férias" e informo a Observacao-Justificativa "Justificativa Teste"
...
Cenario: Consultar Lancamento Periodico com sucesso
    Quando eu informo login "andre.absj" e senha "ctidpf" e clico pra acessar
    E acesso o menu de Lancamento Periodico
    E informo Mes e Ano "11/2019" e clico para Pesquisar
