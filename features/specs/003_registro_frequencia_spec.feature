...
Cenario: Realizar registro de frequencia diario com sucesso
    ...
    E informo Entrada-Inicio "08:00" e Saida-Termino "12:00" e Observacao "Automação: Registrando manualmente"
...
Cenario: Realizar registro de frequencia mensal com sucesso
    ...
    E verifico se ja existe registro inserido, se houver realizo a exclusao e insercao, se nao somente a insercao
