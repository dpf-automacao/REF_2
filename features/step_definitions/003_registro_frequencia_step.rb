...
Entao("eu realizo um registro de frequencia manual diario com sucesso") do
  @registro_frequencia.validar_teste
end
...
Quando("seleciono do primeiro dia util ate o ultimo dia util do mes para exclusao") do
  @registro_frequencia = RegistroFrequenciaPage.new
  @registro_frequencia.excluir_registro_frequencia_mensal
end
...
Entao("eu realizo a insercao do registro de frequencia mensal com sucesso") do
  @registro_frequencia = RegistroFrequenciaPage.new
  @registro_frequencia.validar_registro_mensal
end

Entao("eu realizo a exclusao de um registro de frequencia manual mensal com sucesso") do
  @registro_frequencia = RegistroFrequenciaPage.new
  @registro_frequencia.validar_exclusao_registro_mensal
end
