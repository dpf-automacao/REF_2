...
Quando("Informo Periodo {string} a {string}") do |periodo_inicial, periodo_final|
  @lancamento_periodico.preencher_periodo_inicial(periodo_inicial)
  @lancamento_periodico.preencher_periodo_final(periodo_final)
end

Quando("seleciono o Tipo de Ocorrencia {string} e informo a Observacao-Justificativa {string}") do |tipo_ocorrencia, justificativa|
...
Entao("eu realizo um Lancamento Periodico com sucesso") do
  @lancamento_periodico.consultar_ocorrencia_ferias
  @lancamento_periodico.validando_datas
end
...
Entao("eu realizo a Exclusao dos Lancamento Periodico com sucesso") do
  @lancamento_periodico.validar_exclusao
end
